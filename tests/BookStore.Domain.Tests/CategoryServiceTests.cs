...
namespace BookStore.Domain.Tests
{
    public class CategoryServiceTests
    {
        ...
        [Fact]
        public async void GetAll_ShouldReturnAListOfCategories_WhenCategoryExist()
        {
            var category = CreateCategoryList();

            _categoryRepositoryMock.Setup(c => c.GetAll()).ReturnsAsync(category);
        ...
        [Fact]
        public async void GetAll_ShouldReturnNull_WhenCategoryDoesNotExist()
        {
